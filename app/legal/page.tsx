  ...
  return (
    <div className="legal-page flex flex-col gap-16">
      ...
      <div className="flex flex-col gap-8 leading-relaxed">
        ...
        <h2 className="heading-2">OPEN GAME LICENSE Version 1.0a</h2>

        <p>
          The following text is the property of Wizards of the Coast, Inc. and
          is Copyright 2000 <em>Wizards of the Coast, Inc</em> (“Wizards”). All
          Rights Reserved.
        </p>
        ...
        <p>
          ...
          Dan Dillon, Richard Green, James Haeck, Chris Harris, Jeremy
