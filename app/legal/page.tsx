      ...
      <section className="flex flex-col gap-4">
        ...
        <section className="flex flex-col gap-4 text-sm text-gray-700">
          <p>
            ...
            is Copyright 2000 <em>Wizards of the Coast, Inc</em> (“Wizards”).
            All Rights Reserved.
          </p>
          ...
          <p>
            Creature Codex. Copyright 2018 Open Design LLC; Authors Wolfgang
            Baur, Dan Dillon, Richard Green, James Haeck, Chris Harris, Jeremy
            Hochhalter, James Introcaso, Chris Lockey, Shawn Merwin, and Jon
            Sawatsky.
          </p>

          <p>
            Tome of Beasts. Copyright 2016, Open Design; Authors Chris Harris,
            Dan Dillon, Rodrigo Garcia Carmona, and Wolfgang Baur.
          </p>
